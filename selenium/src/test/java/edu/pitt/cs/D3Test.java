...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    String href = vars.get("x").toString();
    assertEquals("/reset", href.substring(href.length() - 6,href.length()));
  }
  @Test
  ...
  public void tEST3CATALOG() {
    ...
    String href = vars.get("x").toString();
    assertEquals("/images/cat2.jpg", href.substring(href.length() - 16,href.length()));
  }
  @Test
